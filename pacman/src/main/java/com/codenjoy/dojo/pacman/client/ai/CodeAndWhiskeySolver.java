package com.codenjoy.dojo.pacman.client.ai;

import com.codenjoy.dojo.client.Direction;
import com.codenjoy.dojo.client.LocalGameRunner;
import com.codenjoy.dojo.client.Solver;
import com.codenjoy.dojo.client.WebSocketRunner;
import com.codenjoy.dojo.pacman.client.Board;
import com.codenjoy.dojo.pacman.model.Elements;
import com.codenjoy.dojo.pacman.services.GameRunner;
 ...
 */
public class CodeAndWhiskeySolver implements Solver<Board> {

    private DeikstraFindWay way;

    public CodeAndWhiskeySolver(Dice dice) {
    ...
    public List<Direction> getDirections(Board board) {
        ...
        List<Point> to = board.get(Elements.COOKIE);
